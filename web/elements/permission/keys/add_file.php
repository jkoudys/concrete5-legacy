...
<div class="clearfix">
	...
	<?php foreach($extensions as $ext) {
		...
		?>
			<li><label><input type="checkbox" name="extensionInclude[<?=$entity->getAccessEntityID()?>][]" value="<?=$ext?>" <?php if ($checked) { ?> checked="checked" <?php } ?> /> <span><?=$ext?></span></label></li>
		<?php } ?>
	</ul>
	</div>
</div>
...
<div class="clearfix">
	...
	<?php foreach($extensions as $ext) {
		...
		?>
			<li><label><input type="checkbox" name="extensionExclude[<?=$entity->getAccessEntityID()?>][]" value="<?=$ext?>" <?php if ($checked) { ?> checked="checked" <?php } ?> /> <span><?=$ext?></span></label></li>
		<?php } ?>
	</ul>
	</div>
</div>
