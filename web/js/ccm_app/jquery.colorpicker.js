...
(function ($) {
					...
					.eq(0).val(HSBToHex(hsb)).end();
			                    ...
			                    keyDown = function (ev) {
				                const pressedKey = ev.charCode || ev.keyCode || -1;
			                    ...
			                    blur = function (ev) {
				                const cal = $(this).parent().parent();
				                const colorpicker = cal.data('colorpicker');
				...
				// alert(this.parentNode.innerHTML+' '+this.parentNode.id);
				                const colorpicker = $(this).parent().parent().data('colorpicker');
				                    if (colorpicker && colorpicker.fields)
					                    colorpicker.fields.parent().removeClass('colorpicker_focus');
					...
					[ev.data.preview]
				                ...
				                const col = cal.data('colorpicker').color;
				                    cal.data('colorpicker').origColor = col;
				                    setCurrentColor(col, cal.get(0));
				                const cal2 = $('#' + $(this).data('colorpickerId'));
			                    ...
			                    show = function (ev) {
				                const cal = $('#' + $(this).data('colorpickerId'));
		                    ...
		                    return {
			                    init(options) {
				                    ...
				                    return this.each(function () {
						                ...
						                const id = 'collorpicker_' + parseInt(Math.random() * 1000);
