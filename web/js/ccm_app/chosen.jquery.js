...
(function () { let $, Chosen, get_side_border_padding, root;
  ...
  Chosen = (function () {
    ...
    Chosen.prototype.set_up_html = function () {
      let container_div, dd_top, dd_width, sf_width;
    ...
    Chosen.prototype.results_build = function () {
      let content, data, startTime, _i, _len, _ref;
      startTime = new Date();
      this.parsing = true;
    ...
    Chosen.prototype.result_select = function (evt) {
      let high, high_id, item, position;
      if (this.result_highlight) {
    ...
    Chosen.prototype.winnow_results = function () {
      let found, option, part, parts, regex, result_id, results, searchText, startTime, startpos, text, zregex, _i, _j, _len, _len2, _ref;
      startTime = new Date();
    ...
    Chosen.prototype.search_field_scale = function () {
      let dd_top, div, h, style, style_block, styles, w, _i, _len;
      if (this.is_multiple) {
        h = 0;
        w = 0;
