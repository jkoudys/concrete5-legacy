            ...
            <?php } else { ?>
                ...
                <?php foreach ($generated as $p) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($cp->canAdmin()) {
                                print $ih->button(t('Refresh'), $this->action('refresh', $p->getCollectionID(), $this->controller->token->generate('refresh')), 'left', false, array('title'=>t('Refreshes the page, rebuilding its permissions and its name.')));
}?>
                        </td>
                    </tr>
                <?php }
