...
class Auth_OpenID_ServerError
{
     ...
     * @access private
     */
    function Auth_OpenID_ServerError(
        $message = null,
        $text = null,
        $reference = null,
        $contact = null
...
{
    function Auth_OpenID_NoReturnToError(
        $message = null,
...
{
    function Auth_OpenID_MalformedTrustRoot(
        $message = null,
...
class Auth_OpenID_CheckAuthRequest extends Auth_OpenID_Request
{
    ...
    function Auth_OpenID_CheckAuthRequest(
        $assoc_handle,
        $signed,
...
class Auth_OpenID_WebResponse
{
    ...
    function Auth_OpenID_WebResponse(
        $code = null,
        $headers = null,
        $body = null
    ) {
...
{
    function Auth_OpenID_UntrustedReturnURL(
        $message,
        $return_to,
        $trust_root
    ) {
