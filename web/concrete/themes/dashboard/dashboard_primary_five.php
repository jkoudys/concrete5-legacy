...
<tr>
    ...
    <?php $a = new Area('Primary');
    $a->display($c); ?>
    </div>
    </td>
    <td><?php $a = new Area('Secondary 1');
    $a->display($c); ?></td>
</tr>
<tr>
    <td style="width: 34%"><?php $a = new Area('Secondary 2');
    $a->display($c); ?></td>
</tr>
<tr>
    <td style="width: 33%"><?php $a = new Area('Secondary 3');
    $a->display($c); ?></td>
    <td style="width: 33%"><?php $a = new Area('Secondary 4');
    $a->display($c); ?></td>
    <td style="width: 34%"><?php $a = new Area('Secondary 5');
    $a->display($c); ?></td>
</tr>
</table>
</div>
