...
<div id="ccm-tab-content-sitemap" <?php if (!$sitemapSelected) {
?>style="display: none"<?php
} ?>></div>

<div id="ccm-tab-content-explore" <?php if (!$flatSelected) {
?>style="display: none"<?php
} ?>></div>

<div id="ccm-tab-content-search" <?php if (!$searchSelected) {
?>style="display: none"<?php
} ?>></div>
