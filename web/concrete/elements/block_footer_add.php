<?php defined('C5_EXECUTE') or die("Access Denied."); ?>
    ...
    <a href="javascript:void(0)" <?php if ($replaceOnUnload) {
?> onclick="location.href='<?=DIR_REL?>/<?=DISPATCHER_FILENAME?>?cID=<?=$c->getCollectionID()?>'; return true" class="btn ccm-button-left cancel" <?php
} else {
?> onclick="ccm_blockWindowClose()" class="btn ccm-button-left cancel"<?php
} ?>><?=t('Cancel')?></a>
