...
?>
    ...
    <label for="cExternalLinkNewWindow"><input type="checkbox" value="1" <?php if ($c->openCollectionPointerExternalLinkInNewWindow()) {
?> checked <?php
} ?> name="cExternalLinkNewWindow" id="cExternalLinkNewWindow" style="vertical-align: middle" /> <?=t('Open Link in New Window')?></label>
