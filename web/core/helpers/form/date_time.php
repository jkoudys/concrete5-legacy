...
class Concrete5_Helper_Form_DateTime
{
    ...
    public function datetime($prefix, $value = null, $includeActivation = false, $calendarAutoStart = true)
    {
        ...
        if ($calendarAutoStart) {
            $html .= '<script type="text/javascript">$(function() { $("#' . $id . '_dt").datepicker({ dateFormat: ' . json_encode($dateHelper->getJQueryUIDatePickerFormat()) . ', changeYear: true, showAnim: \'fadeIn\' }); });</script>';
        }
...
EOS;
    ...
    public function date($field, $value = null, $calendarAutoStart = true)
    {
        ...
        if ($calendarAutoStart) {
            $html .= '<script type="text/javascript">$(function() { $("#' . $id . '").datepicker({ dateFormat: ' . json_encode($dateHelper->getJQueryUIDatePickerFormat()) . ', changeYear: true, showAnim: \'fadeIn\' }); });</script>';
        }
        return $html;
    }
}
